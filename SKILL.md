...
```i-lang
::DNA{skill:scientific-internet-access}
::META{version:1.8.1|protocol:i-lang_v3.0}

::GENE{behavior|strict}
  T:script_output_only | zero_extra_text | step_by_step
  A:free_association⇒forbidden

::GENE{output}
  T:output_raw | no_wrap | chinese_default
...
Gemini用户如遇到流程异常，建议在OpenClaw设置中切换模型为Claude。
